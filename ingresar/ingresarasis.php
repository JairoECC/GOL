...
if ($_FILES["foto_perfil"]["size"] > 0) {
    ...
    // Si todo está bien, intenta subir el archivo
        ...
        if (move_uploaded_file($_FILES["foto_perfil"]["tmp_name"], $target_file)) {
            ...
            $sentencia = $bd->prepare("INSERT INTO jugador2 (nombre, equipo, asistencia, usu_id, foto) VALUES (?, ?, ?, ?, ?);");
            $resultado = $sentencia->execute([$nombre, $equipo, $asistencia, $usu_id, $target_file]);
    ...
    $sentencia = $bd->prepare("INSERT INTO jugador2 (nombre, equipo, asistencia, usu_id) VALUES (?, ?, ?, ?);");
    $resultado = $sentencia->execute([$nombre, $equipo, $asistencia, $usu_id]);
