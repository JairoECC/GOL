<?php  
	...
	if (!isset($_SESSION['nombre'])) {
		...
		$sentencia = $bd->prepare("SELECT * FROM jugador WHERE nombre = ?;");
...
<body>
	<center>
		...
		<form method="POST" action="editProsGol.php">
			<table>
				<tr>
					<td>Nombre: </td>
				...
				<tr>
					<td>Goles: </td>
					<td><input type="text" class="form-control" name="txtgoles" value="<?php echo $persona->goles; ?>"></td>
				</tr>
				<tr>
					<input type="hidden" name="oculto">
				    <input type="hidden" name="nombre_existente" value="<?php echo $persona->nombre; ?>">
					<td colspan="2">
					    <button id="btnCancelar" type="button" onclick="window.location.href='../paginaingresar.php'">CANCELAR</button>
