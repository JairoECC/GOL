...
if (!isset($_SESSION['nombre'])) {
    ...
    $sentencia = $bd->prepare("SELECT foto, nombre, equipo, asistencia FROM jugador2 WHERE usu_id = ? ORDER BY asistencia DESC LIMIT 10");
...
<body>
	...
	<div class="nombre-goles">
		<div class="divingreso">
			...
			<form method="POST" action="../ingresar/ingresarasis.php" enctype="multipart/form-data">
				<table class="ingreso">
					<tr class="ingreso-one">
						<td>Nombre: </td>
						<td id="input-name-asis"><input type="text" class="form-control" name="txtnombre"></td>
				    </tr>
					<tr class="ingreso-two">
					    <td>Asistencias: </td>
					    <td id="input-asis"><input type="number" class="form-control" name="txtasistencia"></td>
					</tr>
					<tr class="ingreso-three">
						<td>Equipo: </td>
						<td id="input-team-asis"><input type="text" class="form-control" name="txtequipo"></td>
					</tr>
					<tr class="ingreso-four">
						<td>Perfil: </td>
						<td id="input-photo-asis">
		...
		<div class="muestra">
			<table class="tabla-goleador">
				<h3 style="font-family: 'Roboto Mono', monospace;">Asistencias</h3>
				<tr>
                    <th></th>
                    <th>Jugador</th>
					<th></th>
				...
				foreach ($jugador as $dato) {
					...
					<tr>
						...
						<td id="td-stad"><?php echo $dato->asistencia; ?></td>
						<td id="td-edit">
			...
			<div class="view-all">
                <button><i class="fa-solid fa-plus"></i><a href="../viewAll/VAasistencia.php" target="_blank">Ver tabla completa</a></button>
            </div>
		</div>
	</div>
<!-- Contenedor Modal -->
