			...
			<form method="POST" action="../ingresar/ingresarasis.php">
				<table class="ingreso">
					<tr class="ingreso-one">
						<td>Nombre: </td>
						<td style="margin-left: 90px"><input type="text" class="form-control" name="txtnombre"></td>
				    </tr>
					<tr class="ingreso-two">
					    <td>Asistencias: </td>
					    <td style="margin-left: 35px"><input type="number" class="form-control" name="txtasistencia"></td>
					</tr>
