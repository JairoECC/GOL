<?php  
	...
	if (!isset($_SESSION['nombre'])) {
		...
		$sentencia = $bd->query("SELECT nombre, tar_ama FROM jugador3 ORDER BY tar_ama DESC LIMIT 10");
			...
			<table class="tabla-goleador">
				...
				foreach ($jugador as $dato) {
					...
					<tr>
						...
						<td><a class="btn btn-warning" id="edit" href="../editAndDelete/editAma.php?nombre=<?php echo $dato->nombre; ?>">Editar</a></td>
